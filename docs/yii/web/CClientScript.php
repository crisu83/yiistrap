...
class CClientScript extends CApplicationComponent
{
	 ...
	 * and the current application runs with the URL 'http://localhost/docs/index.php',
	 * then the 'comments.js' script will be rendered using URL '/docs/assets/comments.js'.
	 *
